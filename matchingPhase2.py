...
def mainResults(parameterUTT, forriders):
    ...
    #print(returnData)
    if returnData == None or returnData[0] == "no_data":
        ""
    else:
        riders = returnData[0]
        ...
        # Trip Chatty Plus 1
    if foundRiders == [] or filledSeatCount <= forriders or returnData == None:
        userCollection = db.ridersndrivers
        chatUpdate = 0
        if tripChatty == 5:
    ...
    different_char_match = filledSeatCount
    print("Same Zone All Broadcasting Count ", different_char_match)
