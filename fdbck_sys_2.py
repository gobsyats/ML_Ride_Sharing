...
def basic_feedback(userMongoQ, driverMongoQ, userIdQ, driverId, tripId):
    feedback = {}
    commons.update_feedback_status(userIdQ)
    ...
    for i in range(user_count):
        ...
        for j in range(user_count):
            if i != j:
                ratingList = commons.getChar_Extended()
                chat = ratingList[0]
                safe = ratingList[1]
                ...
                if feed_back_type == "rider_to_driver":
                    ...
                    document = {
                        ...
                        "feedback_given_classifier": constants.EMPTY_STRING,
                        "feedback_given_classifier_to_int": 0,
                ...
                #print("The Feedback Document:")
                print("Rating Given by User by", userIdQ[i], "to User", userIdQ[j], ":")
